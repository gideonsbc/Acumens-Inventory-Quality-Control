tableextension 14304115 "AQD QAWhseItemTrackingLine" extends "Whse. Item Tracking Line"
{
    fields
    {
        ...
        //     end;
        // }
        field(14304104; "AQD Restricted"; Boolean)
        {
            FieldClass = FlowField;
            CalcFormula = exist("AQD Item Restrictions" where("Item No." = field("Item No."), "Variant Code" = field("Location Code"), "Lot No." = field("Lot No."), Open = const(true)));
            Editable = false;
            Caption = 'Restricted';
        }
    }
